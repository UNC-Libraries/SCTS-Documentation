...
When appropriate, we also add racial and ethnic identities to key figures documented in the collection. This may include individuals or groups who have significant or meaningful ties to the creator or collector(s), such as a working relationship (e.g. business partners, project collaborators, interviewer/interviewee, documentarian/subject, mentor/mentee, etc) or when the collection contains a substantial amount of materials on specific individuals or groups [^4](#endnotes) (Hart).
