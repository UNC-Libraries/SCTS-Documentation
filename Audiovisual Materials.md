...
For the most part, Technical Services processing archivists physically process and describe AV materials at the item-level to help facilitate preservation via digitization and straemable access via finding aid. Technical Services is currently developing processes for describing & arranging AV materials at other processing levels, including collection and box-level description...stay tuned.
